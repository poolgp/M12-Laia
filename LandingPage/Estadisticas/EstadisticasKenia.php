...
$estadisticasKenia = selectRanking();
...
<head>
    ...
    <title>Estadísticas Kenia</title>
    ...
    <link rel="stylesheet" href="estadisticasKenia.css">
</head>
<body>
    <h1 class="text-center" style="margin: 20px;">Estadísticas Kenia</h1>
    <div class="container">
        <div class="card mt-2">
            <div class="card-header">
                <h4 class="mb-0">KENIA</h4>
            </div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <?php foreach ($estadisticasKenia as $statsKenia){ ?>
                        <tr>
